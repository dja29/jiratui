...
4. Use the default config or start the app in config mode for a manual setup:
...
5. Make an alias for easier access (macOS only):
...
If you used manual config mode, it should already be started. Otherwise:
